...
const NavSm = () => {
    ...
    <>
      <div className="text-white flex items-center justify-between">
          <div>
              <h3 className="text-xl font-bold ">It all Startshere !!</h3>
              <span className="text-gray-400 text-xs flex items ">
  ...
  return (
   ...
   <input 
      type="search"
       ...
       placeholder="Searcg for movies ,events , place , sports and Activities."/>
   </div>
...
const Navbar = ()=>{
   return (
       ...
       <nav className="bg-bms-700 p-4">
         ...
         <div className="hidden md:flex lg:hidden">{/*midden Screen*/}
            <NavMd/>
         </div>
